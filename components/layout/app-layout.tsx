...
export function AppLayout({ sidebar, children }: AppLayoutProps) {
  ...
  return (
    <div className="relative h-screen overflow-hidden bg-background">
      ...
      {!sidebarOpen && (
        <button
          className="fixed left-4 bottom-4 z-30 flex h-12 w-12 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-sm hover:bg-primary/90 hover:translate-y-[-2px] transition-all duration-300"
